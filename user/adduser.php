    ...
    <div class="flex gap-4 w-full border justify-between items-center">
        <div class="flex justify-center w-full h-full gap-4">
            ...
            <div class="flex flex-col justify-center items-center">
                <h1 class="self-center text-3xl font-semibold">Add a Child user</h1>
                <p class="self-center">You are the admin</p>
            </div>
        </div>
        <div class="border rounded-lg m-4 p-4 w-1/2">

            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <h1 class="text-center text-2xl m-2">Add User</h1>
                <hr>
                ...
                <!-- <div class="flex justify-between items-center gap-4">
                    ...
                    <input disabled class="border p-2 rounded-lg text-gray-500" type="text" autocomplete="off" name="parent-email" value="<?php echo $parent_email; ?>">
                </div>
                <p class="error"><span class="error text-xs">* You will the parent of this user.</span></p> -->
                <div class="flex justify-between items-center gap-4">
                    <label>Email :</label>
